...
function (_React$Component) {
  ...
  function SongContainer(props) {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(SongContainer).call(this, props));
    _this.state = {
      songs: props.songs
    };
  ...
  _createClass(SongContainer, [{
    ...
    value: function render() {
      if (this.state.songs.length === 0) {
        //default state
        return React.createElement("div", null, " ", React.createElement("h3", null, " No Songs Yet!"));
      }

      var songList = this.state.songs.map(function (song) {
        //return value for each element passed in
        return React.createElement("div", null, React.createElement("h2", null, song.artist, " - ", React.createElement("i", null, song.title)));
      });
      return React.createElement("div", null, React.createElement("h1", null, "My Facorite Songs!"), songList);
    }
  }]);
...
var init = function init() {
  ReactDOM.render(React.createElement(SongContainer, {
    songs: []
